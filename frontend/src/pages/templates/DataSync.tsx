...
import { Plus, Trash2, Printer, Moon, Sun, Save, Download, ArrowLeft } from 'lucide-react';
            ...
            <div className={`max-w-4xl mx-auto rounded-xl shadow-2xl p-8 print:shadow-none print:p-0 transition-colors ${isDarkMode ? 'bg-slate-800' : 'bg-white'}`}>
                ...
                <div className="flex justify-between items-start mb-12 border-b border-gray-700/50 pb-8">
                    ...
                    <div className="text-right">
                        <div className="mb-4">
                            <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg flex items-center justify-center ml-auto mb-2">
                                <Save className="w-6 h-6 text-white" />
                            </div>
                            <span className="font-bold text-xl">MyBusiness Inc.</span>
                        </div>
